...
class Command(BaseCommand):
    help = (
        "Carga datos de demostración completos: catálogo, clientes y cotizaciones "
        "desde el 1 de enero del año en curso hasta hoy (cotizaciones con notes=SEED_QUOTES)."
    )
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--reset",
            action="store_true",
            help="Regenera cotizaciones SEED_QUOTES (--reset en seed_quotes). El catálogo y clientes usan get_or_create (no borra).",
        )
