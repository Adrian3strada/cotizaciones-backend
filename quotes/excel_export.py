"""Exportación a Excel con diseño para cotizaciones."""
...
def export_quotes_to_excel(queryset, status_labels, max_rows=1000):
    """Genera un archivo Excel con diseño para la lista de cotizaciones."""
    wb = Workbook()
    ws = wb.active
...
def export_report_to_excel(queryset, status_labels, max_rows=2000):
    """Genera un archivo Excel con diseño para el reporte de cotizaciones."""
