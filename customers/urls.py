...
urlpatterns = [
    ...
    path("contactos/<int:pk>/", views.customer_contacts, name="contacts"),
    path("contactos/nuevo/", views.CustomerContactCreateView.as_view(), name="contact_create"),
    path("contactos/<int:pk>/editar/", views.CustomerContactUpdateView.as_view(), name="contact_update"),
]
