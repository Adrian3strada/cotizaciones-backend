...
class CameraModel(models.Model):
    ...
    datasheet_file = models.FileField('Ficha técnica', upload_to='datasheets/', blank=True, null=True)
    base_price = models.DecimalField('Precio base (USD)', max_digits=14, decimal_places=2, help_text='Lista de precios siempre en dólares. En cotizaciones en MXN se convierte con el tipo de cambio de la cotización.')
